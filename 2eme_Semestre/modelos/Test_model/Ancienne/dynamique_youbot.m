...
figure;
plot3(pos_end.signals.values(431:862,1),pos_end.signals.values(431:862,2),pos_end.signals.values(431:862,3))
hold on
plot3(lin_trajectory(1,:),lin_trajectory(2,:),lin_trajectory(3,:),'r')
hold off
axis equal

% test = zeros(3,2*size(lin_trajectory,2));
% for i = 1:2*size(lin_trajectory,2)
%     angle = trajectory(:,i)';
%     test(:,i) = MGD_end(d1,d2,d3,d4,lend,r1,angle(1),angle(2),angle(3),angle(4));
% end
