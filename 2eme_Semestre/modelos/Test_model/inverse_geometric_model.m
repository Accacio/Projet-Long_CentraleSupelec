...
% Fonction: modèle géometrique inverse du robot, pour obtenir un ensemble d'angle des axes du robot qui permet de placer l'outil dans la position désirée.
...
% Sorties: 	joint_DHM = ensemble des angles (theta_1,theta_2,theta_3,theta_4,theta_5) des axes du robot
